...
/** The stored face-lock enrolment. */
export interface FaceLockState {
  enabled: boolean;
  /** ISO timestamp of the last successful scan, or null before the first. */
  lastScannedAt: string | null;
}

export const EMPTY_FACE_LOCK: FaceLockState = {enabled: false, lastScannedAt: null};
...
export const formatScanDate = (iso: string | null | undefined): string | null => {
  if (!iso) return null;
