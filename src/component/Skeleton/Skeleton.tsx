...
import type {ISkeletonProps as RNSkeletonProps} from 'react-native-reanimated-skeleton';
...
export interface SkeletonProps extends Omit<RNSkeletonProps, 'isLoading'> {
  isLoading?: boolean;
  containerStyle?: StyleProp<ViewStyle>;
  /** Use the translucent-white palette, for navy gradient cards. */
  onDark?: boolean;
