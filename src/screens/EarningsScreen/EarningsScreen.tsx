...
/** One row of the earnings table (`toEarningsRows` is already imported). */
...
export default function EarningsScreen({navigation}: MainTabScreenProps<'EarningsTab'>) {
  ...
  const openPayment = (tx: EarningsRow) =>
