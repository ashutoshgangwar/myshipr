...
/**
 * NOTE: this screen is registered in no navigator (see the migration notes),
 * so its props are declared locally rather than derived from a route.
 */
...
const LoadsTab = ({navigation, route}: LoadsTabProps) => {
