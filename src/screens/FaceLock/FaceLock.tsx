...
import type {FaceLockState} from '../../services/FaceLockService';
...
const waitForModalDismiss = () =>
  new Promise<void>(resolve => setTimeout(() => resolve(), MODAL_DISMISS_MS));

const BACK_ICON = IS_TABLET ? 24 : 18;
const CHEVRON = IS_TABLET ? ms(20) : ms(18);

export default function FaceLock({navigation}: RootStackScreenProps<'FaceLock'>) {
  const [faceLock, setFaceLock] = useState<FaceLockState>(EMPTY_FACE_LOCK);
