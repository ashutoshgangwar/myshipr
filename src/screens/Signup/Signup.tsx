...
/** The six per-digit inputs of one OTP block. */
type OtpRefs = React.MutableRefObject<Array<TextInput | null>>;

// Ambiguous glyphs (I/l/1, O/0) are left out so the driver is not asked to
// tell them apart. Five characters, space-separated, matching the seeded
...
const Signup = () => {
  ...
  const mobileOtpRefs = useRef<Array<TextInput | null>>([]);
