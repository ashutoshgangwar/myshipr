...
import styles from './SocialSecurityItin.styles';
...
const SocialSecurityItin= () => {
  ...
  return (
    <View style={styles.screen}>
      ...
      <ScreenHeader title="TIN Verification" />
      ...
      <ScrollView
        ...
        image={image}
        placeholderImage={require('./../../../assets/Image/tin_cer.jpg')} // dynamic
        onScan={handleScan}
      />
        ...
        <ActionButton
          ...
          textColor="#fff"
          onPress={() => navigate.navigate('ProofOfAddress')}
        />
      </ScrollView>
    </View>
  );
...
export default SocialSecurityItin;
