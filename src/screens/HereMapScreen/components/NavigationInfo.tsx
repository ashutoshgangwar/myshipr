...
export function NavigationInfo({
  ...
  /** ETA / remaining figures while guidance is running. */
  navigationInfo?: TripInfo | null;
  /** Distance + duration of the previewed route, before guidance starts. */
  routeSummary?: {length?: number; duration?: number} | null;
