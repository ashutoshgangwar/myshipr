...
export const NAVIGATION_CAMERA_INTERVAL_MS = 80;
export const NAVIGATION_MARKER_ANIMATION_MS = 120;
export const NAVIGATION_MIN_MOVE_METERS = 0.2;
...
export const NAVIGATION_ROUTE_WIDTH = 14;
