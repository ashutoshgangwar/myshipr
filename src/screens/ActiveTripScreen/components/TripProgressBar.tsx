...
export interface TripProgressBarProps {
  /** 0–1; clamped. */
  progress?: number;
  /** The stop just cleared and the one being driven to ("Current" → "P1"). */
  fromLabel?: string;
  toLabel?: string;
  /** Leg summary, e.g. "12 min · 18 km · ETA 5:38 PM", or a routing failure. */
  summary?: string;
  summaryIsError?: boolean;
  withCheckbox?: boolean;
  /** "Reached" while stops remain, "End Trip" on the last leg. */
  endLabel?: string;
  onEndTrip?: () => void;
  /** Reports this card's rendered height, so the verify button can sit flush. */
