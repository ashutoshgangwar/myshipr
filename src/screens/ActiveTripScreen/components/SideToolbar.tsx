...
export interface SideToolbarProps {
  /** Which panel is open, so its button reads as active. */
  panel?: string | null;
  /** Receives the chosen panel id, or 'collapse' when the rail folds away. */
  onSelect: (panel: string) => void;
}

export default function SideToolbar({panel, onSelect}: SideToolbarProps) {
