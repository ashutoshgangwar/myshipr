...
function glyphFor(action?: string, direction?: string): Glyph {
  ...
  const soft = action != null && SOFT_ACTIONS.has(action);
  switch (direction) {
    case 'left':
...
function StraightArrow({color, strokeWidth}: GlyphProps) {
  return (
    <>
      <Path
        d="M12 21 V9"
