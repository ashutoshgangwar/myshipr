...
import HereNavigationDemo from '../screens/HereNavigationDemo/HereNavigationDemo';
...
// Typed with the app's param list, so every <Stack.Screen name> below is
// checked against RootStackParamList and each screen's own props must match
// the route it is registered under.
